...
<input type=hidden name=vulture_app_id value="1">
<input type=hidden name=keep_portal value="1">
<table>
<tr><td>Mot de passe</td><td><input type="password" name="vulture_password2"></td></tr>
<tr><td>Mot de passe (confirmation)</td><td><input type="password" name="vulture_password3"></td></tr>
...
-->
<div style='padding-top: 20px; float: left; margin: 3em'>
<div style='display: __CHANGE_OK__; color: red; padding-bottom: 2em'>
Changement de mot de passe réussi.
</div>
<div style='display: __CHANGE_FAILED__; color: red; padding-bottom: 2em'>
Echec du changement de mot de passe
</div>
Vous pouvez maintenant accéder aux applications suivantes :
<div style='padding-bottom: 5px; text-align: left; padding-left: 4em'>
__FORM__
</div>
